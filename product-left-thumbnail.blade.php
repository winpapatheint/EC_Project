<x-guest-layout>
                            ...
                            <div class="right-box-contain">
                                ...
                                <div class="note-box product-package">
                                    ...
                                    <form method="POST" action="{{ route('show_cart') }}" >
                                        @csrf
                                    <button type="submit"
                                        class="btn btn-md bg-dark cart-button text-white w-100">Add To Cart</button></form>
                                </div>
                                                            ...
                                                            <div class="col-xl-12">
                                                                ...
                                                                <div class="review-title-2">
                                                                    ...
                                                                    <button class="btn" type="button"
                                                                        ...
                                                                        data-bs-target="#writereview{{'1'}}">Write a
                                                                        review</button>
                                                                </div>
                                                            </div>
                                                        </div>
    ...
    <!-- Review Modal Start -->
    <div class="modal fade" id="writereview{{'1'}}" tabindex="-1" aria-labellabedby="exambleModelLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="{{ route ('reviews', '1') }}"  method="POST">
                    @csrf
                    ...
                    <div class="modal-body">  
                        <div class="product-wrapper">
                            ...
                            <div class="review-box">
                                ...
                                <textarea id="comment" rows="3" class="form-control" placeholder="Comments" name="comment"></textarea>
                            </div>
                        </div>
                    ...
                    <div class="slider-6_1 product-wrapper">
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="{{ url('/product-left-thumbnail') }}l">
