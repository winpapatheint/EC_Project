<x-guest-layout>
                                                    ...
                                                    <div class="tab-content" id="pills-tabContent"
                                                        ...
                                                        <div class="tab-pane fade show active" id="pills-home"
                                                            ...
                                                            <div class="review-title-2">
                                                                ...
                                                                <p style="color:red; font-size:12px;">* Choose the date
                                                                    within 7 days.</p>
                                                                <div class="form-floating theme-form-floating"
                                                                    style="margin-top: 10px;">
    ...
    <script
        src="https://www.paypal.com/sdk/js?client-id=AWssbr_5JCWSdK6IogXTxXSw8cVBeb_7gdVCtEue95EqSGYXuATz1fYcAduzXdf8e0k3713fP3tmuW7o&currency=JPY">
