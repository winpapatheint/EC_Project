            ...
            <div class="row g-4">
                <div class="col-xl-8 ratio_65">
                    <div class="home-contain h-100">
                        <div class="h-100">
                            <img src="{{ asset('frontend/assets/images/homepage/' . $tops[0]->image) }}"
                ...
                <div class="col-xl-4 ratio_65">
                    <div class="row g-4">
                            ...
                            <div class="home-contain">
                                ...
                                <div class="home-detail p-center-left home-p-sm w-75">
                                    <div>
                                        ...
                                        <h2 class="mt-0 text-danger">{{ $tops[1]->discount }} <span
                        ...
                        <div class="col-xl-12 col-md-6">
                            <div class="home-contain">
                                <img src="{{ asset('frontend/assets/images/homepage/' . $tops[2]->image) }}"
                                    class="bg-img blur-up lazyload" alt="">
                                <div class="home-detail p-center-left home-p-sm w-75">
                                    <div>
                                        <h2 class="mt-0 text-danger">{{ $tops[2]->discount }} <span
                                                class="discount text-title">OFF</span>
                                        </h2>
                                        ...
                                        @if ($productsGroupedByDiscount[50] != null)
                                            <a href="{{ route('show-discount-product', ['ids' => $productsGroupedByDiscount[50]]) }}"
                                                class="shop-button">Shop Now <i class="fa-solid fa-right-long"></i></a>
                                        @endif
                                    </div>
                                </div>
                            </div>
            ...
            <div class="banner-slider">
                <div>
                    <div class="banner-contain hover-effect">
                        <img src={{ asset('frontend/assets/images/homepage/' . $tops[3]->image) }}
                            class="bg-img blur-up lazyload" alt="">
                        <div class="banner-details">
                            ...
                            @if ($productsGroupedByDiscount[5] != null)
                                <a href="{{ route('show-discount-product', ['ids' => $productsGroupedByDiscount[5]]) }}"
                                    class="banner-button text-white">Shop Now <i
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src={{ asset('frontend/assets/images/homepage/' . $tops[4]->image) }}
                            class="bg-img blur-up lazyload" alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                            ...
                            @if ($productsGroupedByDiscount[10] != null)
                                <a href="{{ route('show-discount-product', ['ids' => $productsGroupedByDiscount[10]]) }}"
                                    class="banner-button text-white">Shop Now
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src={{ asset('frontend/assets/images/homepage/' . $tops[5]->image) }}
                            class="bg-img blur-up lazyload" alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                            ...
                            @if ($productsGroupedByDiscount[15] != null)
                                <a href="{{ route('show-discount-product', ['ids' => $productsGroupedByDiscount[15]]) }}"
                                    class="banner-button text-white">Shop Now <i
                                        class="fa-solid fa-right-long ms-2"></i></a>
                            @endif
                        </div>
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src={{ asset('frontend/assets/images/homepage/' . $tops[6]->image) }}
                            class="bg-img blur-up lazyload" alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                            ...
                            @if ($productsGroupedByDiscount[20] != null)
                                <a href="{{ route('show-discount-product', ['ids' => $productsGroupedByDiscount[20]]) }}"
                                    class="banner-button text-white">Shop Now <i
                                        class="fa-solid fa-right-long ms-2"></i></a>
                            @endif
                        </div>
    ...
    <section class="product-section">
        <div class="container-fluid-lg">
            <div class="row g-sm-4 g-3">
                    ...
                    <div class="p-sticky">
                                ...
                                @foreach ($categories as $list)
                                    <li>
                                        ...
                                        <div class="category-list">
                                            ...
                                            <h5>
                                                <a
                                                    href="{{ url('/categorysidebar/' . $list->id) }}">{{ $list->category_name }}</a>
                                            </h5>
                                        </div>
                                    </li>
                                @endforeach
                            ...
                            <ul class="value-list">
                                <li>
                                    <div class="category-list">
                                        <h5 class="ms-0 text-title">
                                            <a
                                                href="{{ route('show-discount-product', ['topic' => 'value-of-the-day']) }}">Today
                                                Best Seller</a>
                                        </h5>
                                    </div>
                                </li>
                                <li>
                                    <div class="category-list">
                                        <h5 class="ms-0 text-title">
                                            <a
                                                href="{{ route('show-discount-product', ['topic' => 'top-50-offers']) }}">Top
                                                50 Discounts</a>
                                        </h5>
                                    </div>
                                </li>
                                <li class="mb-0">
                                    <div class="category-list">
                                        <h5 class="ms-0 text-title">
                                            <a
                                                href="{{ route('show-discount-product', ['topic' => 'new-arrivals']) }}">New
                                                Arrivals</a>
                                        </h5>
                                    </div>
                                </li>
                        ...
                        <div class="ratio_156 section-t-space">
                            <div class="home-contain hover-effect">
                                <img src="{{ asset('frontend/assets/images/homepage/' . $tops[7]->image) }}"
                                    class="bg-img blur-up lazyload" alt="">
                                <div class="home-detail p-top-left home-p-medium">
                                    <div>
                                        ...
                                        @if ($seafood != null)
                                            <button
                                                onclick="window.open('{{ route('show-discount-product', ['ids' => $seafood]) }}', '_blank');"
                        ...
                        <div class="ratio_medium section-t-space">
                            <div class="home-contain hover-effect">
                                <img src="{{ asset('frontend/assets/images/homepage/' . $tops[8]->image) }}"
                                ...
                                <div class="home-detail p-top-left home-p-medium">
                                    <div>
                                        ...
                                        @if ($vegetableHalfDiscount != null)
                                            ...
                                            <button
                                                onclick="window.open('{{ route('show-discount-product', ['ids' => $vegetableHalfDiscount]) }}', '_blank');"
                                                class="btn btn-animation btn-md mend-auto">Shop Now <i
                                                    class="fa-solid fa-arrow-right icon"></i>
                                            </button>
                                        @endif
                                                    ...
                                                    <div class="offer-detail">
                                                        <div>
                                                            ...
                                                            <h6 class="price theme-color">
                                                                ¥{{ number_format($trending->selling_price, 0, '.', ',') }}
                                                            </h6>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="col-xxl-9 col-xl-8">
                                                    ...
                                                    <div class="col-12 px-0">
                                                        <div class="product-box">
                                                            ...
                                                            <div class="product-image">
                                                                <a
                                                                    href="{{ route('show-product-left-thumbnail', ['id' => $topSaveProduct->id]) }}">
                                                            ...
                                                            <div class="product-detail">
                                                                <a
                                                                    href="{{ route('show-product-left-thumbnail', ['id' => $topSaveProduct->id]) }}">
                                                                    <h6 class="name">
                                                                        {{ $topSaveProduct->product_name }}</h6>
                                                                </a>
                                                                <h5 class="sold text-content">
                                                                    <span
                                                                        class="theme-color price">¥{{ number_format($topSaveProduct->selling_price, 0, '.', ',') }}</span>
                                                                ...
                                                                <div class="product-rating mt-sm-2 mt-1">
                                                                    ...
                                                                    @if ($topSaveProduct->in_stock > 0)
                                                                        <h6 class="theme-color">
                                                                            {{ $topSaveProduct->in_stock }} In Stock
                                                                        </h6>
                                                                    @else
                                            ...
                                            <div class="">
                                                <div class="banner-contain">
                                                    ...
                                                    <div class="banner-details p-center p-4 text-white text-center">
                                                        <div>
                                                            <h3 class="lh-base fw-bold offer-text">{{ $coupon->name }}
                                                            </h3>
                    ...
                    <div class="section-t-space section-b-space">
                        <div class="row g-md-4 g-3">
                            <div class="col-md-6">
                                <div class="banner-contain hover-effect">
                                    <img src="{{ asset('frontend/assets/images/homepage/' . $tops[9]->image) }}"
                                        class="bg-img blur-up lazyload" alt="">
                                    <div class="banner-details p-center-left p-4">
                                        <div>
                                            ...
                                            <h4 class="text-russo fw-normal theme-color mb-2">{{ $tops[9]->phaseone }}
                                            </h4>
                            ...
                            <div class="col-md-6">
                                <div class="banner-contain hover-effect">
                                    <img src="{{ asset('frontend/assets/images/homepage/' . $tops[10]->image) }}"
                                        class="bg-img blur-up lazyload" alt="">
                                    <div class="banner-details p-center-left p-4">
                                        <div>
                    ...
                    <div class="section-b-space">
                        <div class="row g-md-4 g-3">
                            <div class="col-xxl-8 col-xl-12 col-md-7">
                                <div class="banner-contain hover-effect">
                                    <img src="{{ asset('frontend/assets/images/homepage/' . $tops[11]->image) }}"
                                        class="bg-img blur-up lazyload" alt="">
                                    <div class="banner-details p-center-left p-4">
                                        <div>

                                            <h2 class="text-kaushan fw-normal text-danger">{{ $tops[11]->discount }}
                                                Off</h2>

                                            <h2 class="text-kaushan fw-normal theme-color">{{ $tops[11]->phaseone }}
                                            </h2>
                                            ...
                                            @if ($productsGroupedByDiscount[25] != null)
                                                <button
                                                    onclick="location.href = '{{ route('show-discount-product', ['ids' => $productsGroupedByDiscount[25]]) }}';"
                                                    class="btn btn-animation btn-sm mend-auto">Shop Now <i
                                                        class="fa-solid fa-arrow-right icon"></i></button>
                                            @endif
                                        </div>
                            ...
                            <div class="col-xxl-4 col-xl-12 col-md-5">
                                <img src="{{ asset('frontend/assets/images/homepage/' . $tops[12]->image) }}"
                                    class="bg-img blur-up lazyload" alt="">
                                @if ($productsGroupedByDiscount[20] != null)
                                    <a href="{{ route('show-discount-product', ['ids' => $productsGroupedByDiscount[20]]) }}"
                ...
                <div class="section-t-space">
                    <div class="banner-contain hover-effect">
                        <img src="{{ asset('frontend/assets/images/homepage/' . $tops[13]->image) }}"
                            class="bg-img blur-up lazyload" alt="">
                        <div class="banner-details p-center banner-b-space w-100 text-center">
                            <div>
                                ...
                                @if ($vegetable != null)
                                    <button
                                        onclick="location.href = '{{ route('show-discount-product', ['ids' => $vegetable]) }}';"
